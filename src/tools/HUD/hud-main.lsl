...
float  VERSION = 5.4;               // 18 March 2022
...
setConfig(string line)
{
    ...
    if (llList2String(tok,1) != "")
    {
        ...
        else if (cmd == "EFFECTS")         useEffects = (integer)val;
...
// Attempt to load settings and values from Quintonia server
loadState()
{
    if (safetyCheck == FALSE)
    {
        // SAVE DATA TO QUINTONIA SERVER...
/*
