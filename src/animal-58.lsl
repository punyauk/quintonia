// CHANGE LOG
//  This is an interim release before full 5.9 release. It disables the notecard data saving feature due to bugs in that system
//\\
...
float    VERSION = 5.8;    // 5.8   (20 February 2022)
