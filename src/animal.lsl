    ...
    float    VERSION = 5.9;     // 5.9 RC-3  14 March 2022
    ...
    {       
        ...
        if (status != "waitStatusNC")
        {
            ...
            string codedDesc2 = (string)labelType+";" +neatVector(initpos)+";" +qsFloat2String(scaleFactor, 1, FALSE) +";" +(string)AN_AUTO_POO +";" +neatRotation(savedRot) +";" +neatVector(savedPos) +";" +(string)SLEEP_MODE +";" +(string)feedPet +";" +(string)IMMOBILE;
                ...
                else
                {
                    ...
                    if (llList2Integer(desc, 11) != 0)
                    {
                        ...
                        if (llList2Vector(desc, 19) != ZERO_VECTOR)
                        {
                            ...
                            IMMOBILE = llList2Integer(desc, 26);
                        }
                    }
                }
            }
